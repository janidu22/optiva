...
@Table(name = "workout_plans", indexes = {
        ...
        @Index(name = "idx_workout_plans_user_week", columnList = "user_id, week_start_date")
},
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_workout_plans_user_week", columnNames = {"user_id", "week_start_date"})
        })
@Getter
@Setter
@NoArgsConstructor
